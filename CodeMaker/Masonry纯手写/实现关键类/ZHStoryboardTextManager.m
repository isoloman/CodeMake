...
+ (NSMutableDictionary *)defaultDicM{
    ...
    dispatch_once(&onceToken, ^{
        if (ZHStoryboardDicM==nil) {
            ...
            [viewsArr addObject:@"<tableViewController "];////特殊标识符
...
//            [arrM addObject:[self replaceAllIdByCustomClass:newRowStr]];
            ...
            if([tempStr hasPrefix:@"<viewController "]||[tempStr hasPrefix:@"<tableViewController "]){
                NSString * idstr = [tempStr hasPrefix:@"<viewController "]?@"<viewController ":@"<tableViewController ";
                ...
                if([tempStr rangeOfString:@" customClass=\""].location==NSNotFound){
                    ...
                    if ([tempStr hasSuffix:@"sceneMemberID=\"viewController\">"]) {
                        ...
                        NSString *viewCountIdenity=[self getViewCountIdenityWithViewIdenity:idstr];
